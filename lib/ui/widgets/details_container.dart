...
class DetailsContainer extends StatelessWidget {
      ...
      body: SingleChildScrollView(child:
        ...
        if (state is LoadedDetailsMoviesState) {
          return _stack(
              ...
              state.creditsResponse,
              state.listResponseSimilarMovies,
              state.genresOfSimilarMovie);
        }
    ...
    return Stack(
      children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      _movieInfo(genres, movieDetailsResponse, creditsResponse),
                    ],
                  ),
                ),
                Container(
        ...
        Container(
          ...
          height: 155,
          width: 375,
          child: _listWidgetsPhotos(photos),
        ),
        Container(
        ...
        Container(
          ...
          height: 90,
          width: 375,
          child: _listWidgetsCredits(creditsResponse),
        ),
        Container(
        ...
        Container(
          ...
          height: 275,
          width: 375,
          child: _similarMovies(
              context, listResponseSimilarMovies, genresOfSimilarMovie),
        ),
      ],
    );
  }

  Widget _movieInfo(String? genres, MovieDetailsResponse movieDetailsResponse,
      CreditsResponse creditsResponse) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _listWidgetsPhotos(ListPhotoResponse? photos) {
  ...
  Widget _listWidgetsCredits(CreditsResponse creditsResponse) {
    return ListView.builder(
      scrollDirection: Axis.horizontal,
      itemCount: creditsResponse.cast?.length,
      itemBuilder: (ctx, index) {
        return Container(
          child: _imageWidget(index, creditsResponse),
        );
      },
    );
  }

  Widget _imageWidget(int index, CreditsResponse creditsResponse) {
