...
class DetailsContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
          child: BlocBuilder<DetailsMovieBloc, DetailsMovieState>(builder: (context, state) {
            if (state is LoadedDetailsMoviesState) {
              return _stack(state.movieModel, state.genres, state.photos
                  , state.movieDetailsResponse, state.creditsResponse, state.listResponseSimilarMovies
              );
            }
  ...
  Widget _stack(MovieModel? movieModel, String? genres, ListPhotoResponse? photos
      , MovieDetailsResponse movieDetailsResponse, CreditsResponse creditsResponse, ListResponse listResponseSimilarMovies) {
    return Stack(
      children: [
        Container(
          height: 430,
        ...
        Container(
          height: 425, //REVIEW magic numbers
          width: 400, //REVIEW magic numbers
